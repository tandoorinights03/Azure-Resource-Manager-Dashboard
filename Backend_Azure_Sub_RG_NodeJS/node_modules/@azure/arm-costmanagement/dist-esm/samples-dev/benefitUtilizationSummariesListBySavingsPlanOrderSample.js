 ...
 */
function savingsPlanUtilizationSummariesDaily() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.benefitUtilizationSummaries.listBySavingsPlanOrder(savingsPlanOrderId)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
...
//# sourceMappingURL=benefitUtilizationSummariesListBySavingsPlanOrderSample.js.map