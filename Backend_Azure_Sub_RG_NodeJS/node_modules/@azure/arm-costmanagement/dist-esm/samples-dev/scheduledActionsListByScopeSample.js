 ...
 */
function scheduledActionsListByScope() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.scheduledActions.listByScope(scope)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
 ...
 */
function scheduledActionsListByScopeFilterByViewId() {
    var _a, e_2, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const scope = "subscriptions/00000000-0000-0000-0000-000000000000";
        ...
        const resArray = new Array();
        try {
            for (var _d = true, _e = __asyncValues(client.scheduledActions.listByScope(scope, options)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
...
//# sourceMappingURL=scheduledActionsListByScopeSample.js.map