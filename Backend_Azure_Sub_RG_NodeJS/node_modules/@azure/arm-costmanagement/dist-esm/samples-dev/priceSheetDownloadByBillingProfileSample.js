 ...
 */
function pricesheetDownloadByBillingProfile() {
    return __awaiter(this, void 0, void 0, function* () {
        const billingAccountName = "7c05a543-80ff-571e-9f98-1063b3b53cf2:99ad03ad-2d1b-4889-a452-090ad407d25f_2019-05-31";
        const billingProfileName = "2USN-TPCD-BG7-TGB";
        const credential = new DefaultAzureCredential();
        const client = new CostManagementClient(credential);
        const result = yield client.priceSheet.beginDownloadByBillingProfileAndWait(billingAccountName, billingProfileName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=priceSheetDownloadByBillingProfileSample.js.map