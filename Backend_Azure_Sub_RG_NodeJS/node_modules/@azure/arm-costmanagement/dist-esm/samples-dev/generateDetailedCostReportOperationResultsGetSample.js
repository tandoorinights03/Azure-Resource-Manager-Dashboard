 ...
 */
function getDetailsOfTheOperationResult() {
    return __awaiter(this, void 0, void 0, function* () {
        const operationId = "00000000-0000-0000-0000-000000000000";
        const scope = "subscriptions/00000000-0000-0000-0000-000000000000";
        const credential = new DefaultAzureCredential();
        const client = new CostManagementClient(credential);
        const result = yield client.generateDetailedCostReportOperationResults.beginGetAndWait(operationId, scope);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=generateDetailedCostReportOperationResultsGetSample.js.map